...
namespace LantanaGroup.Link.QueryDispatch.Application.Factory
{
    ...
    {
        public ScheduledReportEntity CreateScheduledReport(string facilityId, List<string> reportTypes, string frequency, DateTime startDate, DateTime endDate, string correlationId, string reportTrackingId)
        {
